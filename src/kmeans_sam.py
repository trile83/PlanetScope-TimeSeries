...
def get_pix_data(pl_file, date, writer, im_size=500, start_hidx=0, start_widx=0):
...
def read_dataset(tile_name='tile01', get_label=True, field_fl = '', im_size=1000):
                ...
                for img_dir in img_fls:
                    ...
                    if (float(black_fill) < 0.15 and cloud_pct < 12 and light_haze_pct < 5 and heavy_haze_pct < 3):
                        ...
                        if get_label:
                            ...
                            get_pix_data(fl[0], date, writer, im_size, start_hidx, start_widx)
...
def run():
    ...
    read_dataset(tile_name='tile01', get_label=False, field_fl=field_fl)
